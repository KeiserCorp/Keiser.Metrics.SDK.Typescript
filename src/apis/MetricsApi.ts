...
export class MetricsApi extends runtime.BaseAPI {
    ...
    async facilityStrengthMachineCreate(requestParameters: FacilityStrengthMachineCreateRequest): Promise<FacilityStrengthMachineResponse> {
        ...
        if (requestParameters.strengthMachineId === null || requestParameters.strengthMachineId === undefined) {            
            throw new runtime.RequiredError('strengthMachineId','Required parameter requestParameters.strengthMachineId was null or undefined when calling facilityStrengthMachineCreate.');
        }
        ...
        const response = await this.request({
            path: `/facility/strength-machine/{strengthMachineId}`.replace(`{${"strengthMachineId"}}`, encodeURIComponent(String(requestParameters.strengthMachineId))),
    ...
    async machineAdjustmentCreate(requestParameters: MachineAdjustmentCreateRequest): Promise<MachineAdjustmentResponse> {
        ...
        if (requestParameters.leftPosition !== undefined) {
        ...
        if (requestParameters.rightPosition !== undefined) {
        ...
        return MachineAdjustmentResponseFromJSON(response);
    }
    ...
    async machineAdjustmentList(requestParameters: MachineAdjustmentListRequest): Promise<MachineAdjustmentListResponse> {
        ...
        return MachineAdjustmentListResponseFromJSON(response);
    }
