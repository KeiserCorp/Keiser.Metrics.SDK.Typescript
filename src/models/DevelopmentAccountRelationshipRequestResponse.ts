 ...
 */
export function instanceOfDevelopmentAccountRelationshipRequestResponse(value: object): value is DevelopmentAccountRelationshipRequestResponse {
    if (!('developmentAccountRelationshipRequest' in value) || value['developmentAccountRelationshipRequest'] === undefined) return false;
    return true;
}
