 ...
 */
export function instanceOfFacilityStrengthMachineBulkCreateResponse(value: object): value is FacilityStrengthMachineBulkCreateResponse {
    if (!('facilityStrengthMachines' in value) || value['facilityStrengthMachines'] === undefined) return false;
    if (!('unknownMachines' in value) || value['unknownMachines'] === undefined) return false;
    return true;
}
