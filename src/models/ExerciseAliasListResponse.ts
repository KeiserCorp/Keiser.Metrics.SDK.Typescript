 ...
 */
export function instanceOfExerciseAliasListResponse(value: object): value is ExerciseAliasListResponse {
    if (!('exerciseAliases' in value) || value['exerciseAliases'] === undefined) return false;
    if (!('exerciseAliasesMeta' in value) || value['exerciseAliasesMeta'] === undefined) return false;
    return true;
}
