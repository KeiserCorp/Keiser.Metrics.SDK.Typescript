 ...
 */
export function instanceOfStrengthExerciseMuscleListResponse(value: object): value is StrengthExerciseMuscleListResponse {
    if (!('strengthExerciseMuscles' in value) || value['strengthExerciseMuscles'] === undefined) return false;
    if (!('strengthExerciseMusclesMeta' in value) || value['strengthExerciseMusclesMeta'] === undefined) return false;
    return true;
}
