 ...
 */
export function instanceOfSessionPlanSetResponse(value: object): value is SessionPlanSetResponse {
    if (!('sessionPlanSet' in value) || value['sessionPlanSet'] === undefined) return false;
    return true;
}
