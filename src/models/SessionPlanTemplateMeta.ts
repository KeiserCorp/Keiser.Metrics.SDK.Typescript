 ...
 */
export function instanceOfSessionPlanTemplateMeta(value: object): value is SessionPlanTemplateMeta {
    return true;
}
...
export function SessionPlanTemplateMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionPlanTemplateMeta {
    ...
    return {
        ...
        'scheduleLength': json['scheduleLength'] == null ? undefined : json['scheduleLength'],
